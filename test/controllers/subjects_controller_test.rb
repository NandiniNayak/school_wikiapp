...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { subject_name: @subject.subject_name, year: @subject.year } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { subject_name: @subject.subject_name, year: @subject.year } }
